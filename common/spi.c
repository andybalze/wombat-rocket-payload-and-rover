...
static void (*current_transaction_complete_callback)(const spi_message_element_t *received_message);
...
void spi_begin_transaction(
  ...
  void (*transaction_complete_callback)(const spi_message_element_t *received_message)
) {
