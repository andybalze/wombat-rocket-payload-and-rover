...
cube_dependencies = cube/standalone/main.c cube/standalone/application.h cube/standalone/application.c common/uart.c common/uart.h common/spi.h common/spi.c cube/common/networking_constants.h cube/common/address_resolution.h cube/common/address_resolution.c cube/common/transport.h cube/common/transport.c cube/common/network.h cube/common/network.c cube/common/data_link.h cube/common/data_link.c
