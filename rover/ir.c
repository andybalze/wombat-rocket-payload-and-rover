...
int16_t ir_distance_read(void) {
    ...
    ir_distance_cm = -(ir_distance_adc/12)+61;  // Verified division works properly, when negative is added it sets to 2's complement, when added the adc read value goes to zero...
