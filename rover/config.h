...
// Uncomment this if you want to enable the dance routine.
// The Wombat will behave normally unless you press the LOAD button while in
// flight mode, at which point it will execute the dance_routine() function.
#define DANCE_ROUTINE_ENABLE
